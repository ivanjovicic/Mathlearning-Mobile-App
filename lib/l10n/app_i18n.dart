...
class AppI18n {
  ...
  String get enterUsername => _pick(
        en: 'Enter username',
        sr: 'Unesi korisnicko ime',
      );
  String get enterPassword => _pick(
        en: 'Enter password',
        sr: 'Unesi lozinku',
      );
  ...
  String hello(String fallbackName) => _pick(
        en: 'Hello, $fallbackName',
        sr: 'Zdravo, $fallbackName',
      );
  String get fallbackStudent => _pick(
        en: 'student',
        sr: 'ucenik',
      );
  String get fallbackPlayer => _pick(
        en: 'player',
        sr: 'igrac',
      );
  String get badges => _pick(en: 'Badges', sr: 'Bedzevi');
  String get activity => _pick(en: 'Activity', sr: 'Aktivnost');
  String streakDays(int value) => _pick(
        en: '$value days',
        sr: '$value dana',
      );
  String streakInRowDays(int value) => _pick(
        en: '$value day streak',
        sr: '$value dana niza',
      );
  String coins(int value) => _pick(
        en: '$value coins',
        sr: '$value coina',
      );
  String level(int value) => _pick(
        en: 'Level $value',
        sr: 'Nivo $value',
      );
  String get continueLearning => _pick(
        en: 'Continue learning',
        sr: 'Nastavi ucenje',
      );
  String get readyForNewRound => _pick(
        en: 'Ready for a new round?',
        sr: 'Spremno za novu rundu?',
      );
  String get pickTopicAndStart => _pick(
        en: 'Pick a topic and start the quiz',
        sr: 'Odaberi temu i kreni na kviz',
      );
  String get chooseTopic => _pick(
        en: 'Choose topic',
        sr: 'Izaberi temu',
      );
  ...
  String dailyGoalShort(int done, int target) => _pick(
        en: '$done / $target goal',
        sr: '$done / $target cilj',
      );
  String todayProgress(int done, int target) => _pick(
        en: '$done / $target today',
        sr: '$done / $target danas',
      );
  ...
  String get learningTopics => _pick(
        en: 'Learning topics',
        sr: 'Teme za ucenje',
      );
  String get homeArena => _pick(
        en: 'Home Arena',
        sr: 'Pocetna arena',
      );
  String get missionTopics => _pick(
        en: 'Mission topics',
        sr: 'Teme misije',
      );
  String get allTopics => _pick(
        en: 'All topics',
        sr: 'Sve teme',
      );
  ...
  String get readyForQuiz => _pick(
        en: 'Ready for quiz',
        sr: 'Spremna za kviz',
      );
  String get readyToPlay => _pick(
        en: 'Ready to play',
        sr: 'Spremno za igranje',
      );
  ...
  String get launchNextQuiz => _pick(
        en: 'Launch next quiz',
        sr: 'Pokreni sledeci kviz',
      );
  String get navHome => _pick(
        en: 'Home',
        sr: 'Pocetna',
      );
  String get navQuiz => _pick(
        en: 'Quiz',
        sr: 'Kviz',
      );
  String get navRank => _pick(
        en: 'Rank',
        sr: 'Rang',
      );
  ...
  String get noQuestions => _pick(
        en: 'No questions available',
        sr: 'Nema dostupnih pitanja',
      );
  ...
  String questionLabel(int value) => _pick(
        en: 'Question $value',
        sr: 'Pitanje $value',
      );
  String correctXp(int xp) => _pick(
        en: 'Correct! +$xp XP',
        sr: 'Tacno! +$xp XP',
      );
  String get wrongKeepGoing => _pick(
        en: 'Incorrect, keep going',
        sr: 'Netacno, idemo dalje',
      );
  String get finishQuiz => _pick(
        en: 'Finish quiz',
        sr: 'Zavrsi kviz',
      );
  String get nextQuestion => _pick(
        en: 'Next question',
        sr: 'Sledece pitanje',
      );
  String get mathChallengeTitle => _pick(
        en: 'Math Challenge',
        sr: 'Math izazov',
      );
  ...
  String comboLabel(int combo) => _pick(
        en: 'Combo x$combo',
        sr: 'Combo x$combo',
      );
  String noHintBonus(int xp) => _pick(
        en: 'No-hint bonus +$xp XP',
        sr: 'Bonus bez pomoci +$xp XP',
      );
  ...
  String get settingsQuest => _pick(
        en: 'Settings Quest',
        sr: 'Settings Quest',
      );
  ...
  String get sectionProfile => _pick(
        en: 'Profile',
        sr: 'Profil',
      );
  ...
  String get sectionQuizExperience => _pick(
        en: 'Quiz experience',
        sr: 'Kviz iskustvo',
      );
  ...
  String get formulaToggleSubtitle => _pick(
        en: 'Allow formula hint',
        sr: 'Dozvoli formula hint',
      );
  String get clueToggleTitle => _pick(
        en: 'Small clue',
        sr: 'Mali clue',
      );
  String get clueToggleSubtitle => _pick(
        en: 'Allow clue hint',
        sr: 'Dozvoli clue hint',
      );
  String get eliminateToggleTitle => _pick(
        en: 'Eliminate one',
        sr: 'Eliminacija odgovora',
      );
  String get eliminateToggleSubtitle => _pick(
        en: 'Allow 50/50 hint',
        sr: 'Dozvoli 50/50 hint',
      );
  String get sectionNotifications => _pick(
        en: 'Notifications',
        sr: 'Notifikacije',
      );
  String get dailyReminderTitle => _pick(
        en: 'Daily reminder',
        sr: 'Daily reminder',
      );
  ...
  String get sectionThemeAndApp => _pick(
        en: 'Theme and app',
        sr: 'Tema i app',
      );
  String get advancedThemeTitle => _pick(
        en: 'Advanced theme options',
        sr: 'Napredne tema opcije',
      );
  String get advancedThemeSubtitle => _pick(
        en: 'Reduce motion, contrast and preview',
        sr: 'Reduce motion, contrast i preview',
      );
  String get sectionAudioHaptics => _pick(
        en: 'Audio and haptics',
        sr: 'Audio i haptika',
      );
  String get soundEffectsTitle => _pick(
        en: 'Sound effects',
        sr: 'Sound effects',
      );
  String get soundEffectsSubtitle => _pick(
        en: 'Click and feedback sound',
        sr: 'Klik i feedback zvuk',
      );
  String get vibrationTitle => _pick(
        en: 'Vibration',
        sr: 'Vibration',
      );
  ...
  String get darkLightMode => _pick(
        en: 'Dark / Light mode',
        sr: 'Dark / Light mode',
      );
  ...
  String get visualTheme => _pick(
        en: 'Visual theme',
        sr: 'Vizuelna tema',
      );
  String get profileSetupQuest => _pick(
        en: 'Profile setup',
        sr: 'Profil podesavanje',
      );
  String get reminderDecisionQuest => _pick(
        en: 'Reminder decision',
        sr: 'Reminder odluka',
      );
  String get themeChoiceQuest => _pick(
        en: 'Theme choice',
        sr: 'Tema izbor',
      );
  String get hintsPrefQuest => _pick(
        en: 'Hints preference',
        sr: 'Hints preference',
      );
  String get soundVibrationQuest => _pick(
        en: 'Sound & vibration',
        sr: 'Sound & vibration',
      );
  String get formulaHintTitle => _pick(
        en: 'Formula hint',
        sr: 'Formula pomoci',
      );
  ...
  String get showNextStep => _pick(
        en: 'Show next step',
        sr: 'Prikazi sledeci korak',
      );
  String get showAllSteps => _pick(
        en: 'Show all steps',
        sr: 'Prikazi sve korake',
      );
  String formulaStepCounter(int current, int total) => _pick(
        en: 'Step $current of $total',
        sr: 'Korak $current od $total',
      );
}
